                        ...
                        <div className="col-12" style={{ padding: "10px" }}>
                           <div className="row">
                              <div
                                 ...
                                 <h2>Nhóm sản phẩm của ngành {nameCategory}</h2>
                              </div>
                              <div className="col-12">
                                 <table
                                    ...
                                    {check === false ? (
                                       <>
                                          <p
                                             ...
                                             Biểu đồ doanh thu tổng của{" "}
                                             {productDetail[0].product}
                                             <b
                                                style={{
                                                   color: "rgb(238, 77, 45)",
                                                }}>
