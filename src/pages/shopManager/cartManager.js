    ...
    return (
        <>
            <div className="col-10 bg-light">
                <div className="row">
                    <div className="col-12" style={{width: '100%', height: '700px'}}>
                        ...
                        <div className="col-12" style={{paddingTop: '31px', height: '100px'}}>
                            <Formik initialValues={{idShop: '', valueInput: '', page: ''}} onSubmit={values => {
                                handleSearch(values)
                            }}>
                                <Form>
                                    <div className="row">
                        ...
                        <div className="col-12" style={{width: '100%', height: '80px'}}>
                            <div className="row">
                                <div className="col-2" style={{marginTop: '12px', marginLeft: '5px'}}>
                                    <a type={'submit'} className="notification" style={{textDecoration: 'none'}}>
                                        <span style={{color: 'rgb(238, 77, 45)'}}><b>Trạng thái đơn</b></span>
                                    </a>
                                </div>
                                <div className="col-2" style={{marginTop: '12px', marginLeft: '-20px'}}>
                                    {statusCart === "" ?
                                        <>
                                ...
                                <div className="col-2" style={{marginTop: '12px', marginLeft: '-100px'}}>
                                ...
                                <div className="col-2" style={{marginTop: '12px', marginLeft: '-40px'}}>
                                ...
                                <div className="col-2" style={{marginTop: '12px', marginLeft: '-70px'}}>
                                    {statusCart === "hủy đơn" ?
                                        <>
                                        ...
                                        <>
                                            <button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    navigate("/shop-manager/" + id + "/cart/" + id + "?page=" + (Number(page1) + 1)
                                                    );
                                                    window.scrollTo({
                                                        top: 900,
                                                        behavior: "smooth",
