...
import {createAddress, deleteAddress, editAddress, getAllAddress} from "../../service/addressUser";
        ...
        <>
            <div className="row">
                <div className="col-12" style={{width: '400px', height: '550px'}}>
                    <div className="row">
                        <div className="col-12" style={{width: '400px', height: '80px'}}>
                            <div className="row">
                                <div className="col-6" style={{paddingTop: '26px', paddingLeft: '30px'}}>
                                    <h5>Địa chỉ của tôi</h5>
                                </div>
                                <div className="col-6" style={{paddingTop: '20px', paddingLeft: '280px'}}>
                                    <button type={'button'} className="btn btn" data-toggle="modal"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                             ...
                                             style={{marginBottom: '3px', color: 'white'}}>
                                                ...
                                                <div className="modal-dialog modal-dialog-centered">
                                                    <div className="modal-content">
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col-12"
                                                                    ...
                                                                    <div className="row">
                                                                        ...
                                                                        <div className="col-6"
                                                                             style={{width: '100%', height: '40px'}}>
                                                                            <Field name={'phoneAddress'} type="text"
                                                                                   style={{
                                                                                       width: '95%',
                                                                                       height: '35px'
                                                                                   }}
                                                                    ...
                                                                    <div className="row">
                                                                        <div className="clo-6">
                                                                            <div className="wrapper">
                                                                                <Field type="radio" name="typeAddress"
                                                                                       id="option-1"
                                                                                       value={'văn phòng'}/>
                                                                                <Field type="radio" name="typeAddress"
                                                                                       id="option-2"
                                                        ...
                                                        <div className="modal-footer">
                                                            ...
                                                            <button type="submit" className="addModal">Hoàn thành
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="col-11" style={{marginTop: '10px', marginLeft: '15px'}}><h5>Địa chỉ</h5></div>
                        <div className="col-11"
                             style={{marginTop: '10px', height: '400px', marginLeft: '15px'}}>
                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            <div className="row">
                                                ...
                                                <div className="col-12" style={{marginTop: '-15px', color: 'gray'}}>
                                                    <div style={{
                                                        border: '1px rgb(238, 77, 45) solid',
                                                        width: '80px',
                                                        textAlign: 'center',
                                                        color: 'rgb(238, 77, 45)'
                                                    }}><small>{item.typeAddress}</small></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-6">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-10" style={{textAlign: "right"}}>
                                                            <button type="button" class="btn btn-primary"
                                                                    data-toggle="modal"
                                                                    data-target={"#exampleModal" + item.idAddress}>
                                                                Edit
                                                            </button>
                                                            <Formik initialValues={item} enableReinitialize={true} onSubmit={values => {
                                                                handleEditAddress(values).then()
                                                            }}>
                                                                <Form>
                                                                    <div class="modal fade"
                                                                         id={"exampleModal" + item.idAddress}
                                                                                    ...
                                                                                    <div className="col-12">
                                                                                        <div className="row">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <label>
                                                                                                        <select
                                                                                                            ...
                                                                                                            <option value="" selected>{item.province}</option>
                                                                                                            {provinces && provinces.map((item, key) => (
                                                                                                                <>
                                                                                                                    <option
                                                                                                                        value={item.province_name}>{item.province_name}</option>
                                                                                                                </>
                                                                                                            ))}
                                                                                                        </select>
                                                                                                    </label>
                                                                                            ...
                                                                                            <div className="col-6"
                                                                                                ...
                                                                                                <div
                                                                                                    className="selectdiv1">
                                                                                                    <label>
                                                                                                        <select
                                                                                                            onChange={(e) => {
                                                                                                                setDistrict(e.target.value);
                                                                                                            }}>
                                                                                                            <option value="" selected>{item.district}</option>
                                                                                                            {districts &&
                                                                                                                districts.map((item, key) => (
                                                                                                                    <>
                                                                                                                        <option
