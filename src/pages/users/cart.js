                                                        ...
                                                        {item.statusCart === "hoàn thành" &&
                                                            <>
                                                                ...
                                                                <div className="modal fade"
                                                                     id={"exampleModal" + item.idCart} tabindex="-1"
                                                                        ...
                                                                        <div className="modal-content">
                                                                            <div className="modal-header">
                                                                                <h5 className="modal-title"
                                                                                    id="exampleModalLabel">Đánh Giá Sản
                                                                                    Phẩm</h5>
                                                                            </div>
                                                                            <Formik initialValues={{assessment: '',reviews: '', idProduct: item.idProduct, idUser: ''}}
                                                                                    validationSchema={SignupSchema}
                                                                                    onSubmit={values => {
                                                                                        handleFeedback(values).then()
                                                                                    }}>
                                                                                <Form>
                                                                                    <div className="modal-body">
                                                                                        <div className="row">
                                                                                            ...
                                                                                            <div className="col-12">
                                                                                                    <label htmlFor="exampleFormControlTextarea1" style={{color:'gray'}}>Hãy chia sẻ những điều bạn thích về sản phẩm này với những người khác</label>
                                                                                                    <Field as={'textarea'} className="form-control" id="exampleFormControlTextarea1" name={'reviews'} rows="3"></Field>
                                                                                            </div>
                                                                                            <div className="col-12"><div style={{ color: "red" }}>
                                                                                                <ErrorMessage
                                                                                                    name={"reviews"}
                                                                                                />
                                                                                            </div></div>
                                                                                    ...
                                                                                    <div className="modal-footer">
                                                                                        ...
                                                                                        <button type="submit"
                                                                                                className="btn btn" style={{backgroundColor: 'rgb(238, 77, 45)', color: 'white'}}>Hoàn thành</button>
                                                                                    </div>
                                                                                </Form>
                                                                            </Formik>
                                                                        </div>
