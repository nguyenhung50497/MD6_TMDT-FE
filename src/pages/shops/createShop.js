                        ...
                        {check === '1' ?
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-10">
                                            <div className="row">
                                                ...
                                                <div className="col-12" style={{paddingLeft: '302px'}}><h5>Chào mừng đến
                                                    HNH!</h5></div>
                                                <div className="col-12" style={{paddingLeft: '230px'}}><p>Để đăng ký bán
                                                    hàng trên HNH, bạn cần cung cấp</p></div>
                            ...
                            : check === '2' ?
                                ...
                                <Formik initialValues={{
                                    nameShop: '',
                                    emailShop: profile !== undefined && profile.emailUser,
                                    phoneShop: profile !== undefined && profile.phoneUser,
                                    description: '',
                                    imageShop: '',
                                    idTransport: '',
                                    idUser: ''
                                        ...
                                        <div className="col-12">
                                            <div className="row">
                                                <div className="col-2" style={{height: '420px', textAlign: 'right'}}>
                                                    <div className="row">
                                                        <div className="col-12" style={{marginTop: '35px'}}><p>Tên
                                                            shop</p>
                                                        </div>
                                                        <div className="col-12" style={{marginTop: '35px'}}><p>Địa chỉ
                                                            lấy
                                                            hàng :</p></div>
                                                        <div className="col-12" style={{marginTop: '30px'}}><p>Email</p>
                                                        </div>
                                                        <div className="col-12" style={{marginTop: '30px'}}><p>Số điện
                                                            thoại</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-7" style={{height: '420px', textAlign: 'left'}}>
                                                                    ...
                                                                    <div className="modal-content">
                                                                        <div className="modal-header">
                                                                            <h5 className="modal-title"
                                                                                id="exampleModalLabel">Thêm địa chỉ cho shop</h5>
                                                                            <button type="button"
                                                                                    className="close"
                                                                                    data-dismiss="modal"
                                                                                    aria-label="Close">
                                                    ...
                                                    <div className="col-12" style={{marginTop: '30px'}}><Field
                                                        ...
                                                        <small>Nếu muốn đổi số điện thoại và email, bạn vui lòng chỉnh
                                                            sửa tại <Link to={'/account'}
                                                                          style={{textDecoration: 'none'}}>"Hồ sơ của
                                                                tôi"</Link> ở trang chủ HNH sau khi hoàn tất quá trình
                                                            đăng ký</small>
                                                    </div>
                                                    <div className="col-12" style={{marginTop: '30px'}}>
                            ...
                            <div className="col-12" style={{marginLeft: '20px'}}>
                            <small>Chọn đơn vị vận chuyển phù hợp cho shop của bạn</small>
                            </div>
                            <div className="col-12">
                            <hr/>
                            </div>
                            ...
                            <div className="row">
                            <div className="col-6" style={{paddingLeft: '200px', color:"rgb(238,77,45)"}}><h2>Đơn vị vận chuyển</h2></div>
