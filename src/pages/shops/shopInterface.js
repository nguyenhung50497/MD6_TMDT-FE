    ...
    return (
        <>
            <div className="row">
                ...
                <div className="col-12">
                    <div className="row">
                        <div className="col-12" style={{backgroundColor: 'white', height: '250px'}}>
                            <div className="row">
                                    ...
                                    <div className="row">
                                        <div className="col-4" style={{
                                            ...
                                            <div className="col-12">
                                                <div className="row">
                                                    <div className="col-2"
                                                         style={{marginTop: '14px', paddingLeft: '24px'}}>
                                                        <img src={shop !== undefined && shop.imageShop} alt=""
                                                             width={'72px'} height={'72px'}
                                                             style={{borderRadius: '100%', border: '2px gray solid'}}/>
                                                    </div>
                                                    <div className="col-8">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-12" style={{
                                                                ...
                                                                <p><b>Địa chỉ: {shop.addressShop}</b></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            {shop !== undefined && shop.idUser !== idUser ?
                                                <>
                                                    <div className="col-12">
                                                        <div className="row">
                                                            <div className="col-6">
                                                                <button type={"submit"} className={'shopInterface'}>
                                                                    Theo dõi
                                                                </button>
                                                            </div>
                                                            <div className="col-6">
                                                ...
                                                <>
                                                    <div className="col-12">
                                                        <div className="row">
                                                            <div className="col-6">
                                                                <Link to={'/account'}>
                                                                    <button className={'shopInterface'}
                                                                            type={"submit"}>Chỉnh
                                                                        sửa shop
                                                                    </button>
                                                                </Link>
                                                            ...
                                                            <div className="col-6">
                                                                <button type={"submit"} className={'shopInterface'}>Quản
                                                                    lý
                                                                    shop
                                                                </button>
                                                            </div>
                                                                ...
                                                                <div className="row">
                                                                    <div className="col-9">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                             ...
                                                                             viewBox="0 0 16 16" style={{marginTop: '-5px',marginRight:'10px'}}>
                                                                            <path
