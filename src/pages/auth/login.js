                    ...
                    <div className="row">
                        <div className="col-6">
                            <div className="row">
                                ...
                                <div style={{paddingLeft: '30px', fontSize: '35px', marginTop: '16px'}}><p>Đăng nhập</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="col-11" style={{margin: '16px'}}>
                                        <div className="row">
                                                    ...
                                                    <Form>
                                                        ...
                                                        <div className="form-group" style={{marginTop: '30px'}}>
                                                            <Field name={'password'} type="password" className="form-control"
                                                                   placeholder={'Mật khẩu'} style={{height: '50px',borderRadius: '5px'}}/>
                                            ...
                                            <div className="col-12" style={{marginTop: '10px'}}>
                                                <div className="row">
                                                    <div className="col-8" style={{textAlign: 'right'}}><p style={{
                                                        textAlign: "center",
                                                        marginLeft: '30px',
                                                        color: 'rgba(33,37,41,0.5)'
                                                    }}>Bạn mới biết đến HNH</p></div>
                                                    <div className="col-4">
                                                        <Link to ={'/register'} type="submit" style={{
                                                            textDecoration: 'none',
                                                            color: 'rgb(238,77,45)',
                                                            marginRight: '15px'
                                                        }}>Đăng kí</Link>
