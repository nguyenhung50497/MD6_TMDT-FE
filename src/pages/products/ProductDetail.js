                        ...
                        <span
                           ...
                           {mediumStart}{" "}
                            ...
                            <div className="text-danger mt-1">
                                <Rating initialValue={mediumStart} readonly style={{width: '100%', height: '50px'}}/>
                            </div>
                        </div>
                    </div>
                    {feedbackProduct && feedbackProduct.map(item => (
                        <>
                            <div className="row mt-5 ml-1 mb-2 pl-4 pb-4"
                                 style={{width: "100%"}}>
                                <div className="col-1">
                                    <img
                                        src={item.avatar}
                                ...
                                <div className="col-11">
                                    ...
                                    <div className="text-danger">
                                        <Rating initialValue={item.assessment} readonly
