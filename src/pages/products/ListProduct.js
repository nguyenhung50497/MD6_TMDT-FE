        ...
        <>
            <div className="row mt-2">
                ...
                <div className="col-8 row" style={{marginLeft: "-1px"}}>
                    <div className="col-12 bg-light pt-3" style={{border: "1px solid rgb(231, 229, 229)", height: "60px"}}>
                        <strong className="text-secondary">DANH MỤC</strong>
                    </div>
                    {categories && categories.map((item, key) =>(
                        <div className="col-2 bg-light" style={{border: "1px solid rgb(231, 229, 229)"}}>
                            <div>
                                <img src={item.imageCategory} alt="" style={{width: "100%", height: "150px"}} />
            ...
            <div className="row mt-3">
                ...
                <div className="col-8 row" style={{marginLeft: "-1px"}}>
                    <div className="col-12 bg-light pt-3 text-center" style={{border: "1px solid rgb(231, 229, 229)", height: "60px", fontSize: "20px"}}>
                        <strong className="text-danger">Sản Phẩm</strong>
                    </div>
                                { products !== undefined &&
                                products.map((item, key) => (
                                    <>
                                    <div key={key} className="col-lg-2 col-md-3 p-1">
                                        <div>
                                            <div className="bg-light shadow-sm" style={{height: "300px"}}>
                                                <Link to={`product-detail/${item.idProduct}`} style={{textDecoration: 'none'}}>
                                                    <img className="img-fluid" src={item.image} style={{height: "200px", width: "100%"}} alt=""/>
                                                </Link>                                           
                                                <div className="mt-2">
                                                    ...
                                                    <button className="btn btn-danger"
                                                        onClick={() => {
                                                            ...
                                                            .then((willDelete) => {
                                                            if (willDelete) {
                                                                dispatch(deleteProduct(item.idProduct)).then(()=>{
                                                                    dispatch(getProducts(1)).then(()=>{
                                                                        navigate('/home')
                                                                    })
                                                                })
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-secondary mr-1 mt-1" style={{float: "right", fontSize: "13px"}}>
                                                            ...
                                                            {item.sold >= 1000 && <>Đã bán: {((item.sold)/1000).toFixed(1)}k</>}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
