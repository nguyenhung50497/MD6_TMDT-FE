                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            <div className="col-12">
                                                <div className="row">
                                                    <div className="col-6">
                                                        <small style={{marginRight: '10px'}}> Tải ứng dụng | Kết
                                                            nối </small> <small
                                                        style={{marginRight: '10px'}} title={'facebook'}>
                                                    ...
                                                    </small> <small style={{marginRight: '10px'}} title={'instagram'}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                             fill="currentColor"
                                        ...
                                        <div className="col-6" style={{textAlign: 'right'}}>
                                            <div className="row">
                                                <small className="col-6" style={{marginLeft: '150px'}}
                                                       title={'hỗ trợ'}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    <small style={{marginRight: '10px'}}> Hỗ trợ</small>
                        ...
                        <div className="col-8" style={{height: '120px', color: 'white'}}>
                            <div className="row">
                                <div className="col-12" style={{height: '30px'}}>
                                    <div className="row">
                                        <div className="col-6">
                                            <small style={{marginRight: '10px'}}> Tải ứng dụng | Kết nối </small> <small
                                            style={{marginRight: '10px'}} title={'facebook'}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                 fill="currentColor"
                                                 className="bi bi-facebook" viewBox="0 0 16 16">
                                        ...
                                        <div className="col-6" style={{textAlign: 'right'}}>
                                            <div className="row">
                                                ...
                                                {user !== undefined && user === null ?
                                                    ...
                                                    :
                                                    <>
                                                        <div className="dropdown-menu col" style={{
                                                            backgroundColor: 'rgb(238,77,45)',
                                                            border: 'none',
                                                            marginTop: '-10px'
                                                        }}>
                                                            <button className="nut_dropdown"><img
                                                                src={profile !== undefined && profile.avatar}
                                                                alt="" width={'20px'}
                                                                height={'20px'}
                                                                style={{borderRadius: '100%'}}/>
                                                                <small>{profile !== undefined && profile.fullName}</small>
                                                            </button>
                                                            <div className="noidung_dropdown">
                                                                <Link to={'/account'} className="btn" type={'submit'}>Tài
                                                                    khoản của tôi</Link>
