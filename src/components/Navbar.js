...
import {editNotification, getNotificationsByReceiver} from "../service/notificationService";
                                            ...
                                            <div
                                                ...
                                                <a
                                                    ...
                                                    <div className="badge-block" style={{marginLeft: '-20px'}}>
                                                        ...
                                                        <span
                                                            className="e-badge e-badge-light e-badge-overlap e-badge-notification text-danger">
                                             {sum && sum}
                                          </span>
                                                    </div>
                                                </a>
                                        ...
                                        <div className="col-1" style={{marginTop: '28px', marginLeft: '40px'}}>
                                            <div className="dropdown-menu1">
                                             ...
                                             {total}
                                                ...
                                                <button className="nut_dropdown1"
                                                ...
                                                <div className="noidung_dropdown1">
                                                    {notifications && notifications.map(item => (
                                                        <>
                                                            {item.contentNotification === 'waiting' ?
                                                                <>
                                                                    {item.statusNotification === 'chuadoc' ?
                                                                        <>
                                                                            <p style={{color: 'red'}}
                                                                               onClick={() => handleStatusNotification(item.idNotification)}>
                                                                                Đơn hàng {item.idCart} của bạn đã được
                                                                                xác nhận
                                                                            </p>
                                                                        </>
                                                                        :
                                                                ...
                                                                : item.contentNotification === 'delete' ?
                                                                    <>
                                                                        {item.statusNotification === 'chuadoc' ?
                                                                            <>
                                                                                <p style={{color: 'red'}}
                                                                                   onClick={() => handleStatusNotification(item.idNotification)}>
                                                                                    Đơn hàng {item.idCart} của bạn đã bị
                                                                                    hủy
                                                                                </p>
                                                                            </>
                                                                            :
                                                                    ...
                                                                    : item.contentNotification === 'feedback' ?
                                                                        <>
                                                                            {item.statusNotification === 'chuadoc' ?
                                                                                <>
                                                                                    <p style={{color: 'red'}}
                                                                                       onClick={() => handleStatusNotification(item.idNotification)}>
                                                                                        Sản phẩm id {item.idProduct} của bạn vừa được đánh giá
                                                                                    </p>
                                                                                </>
                                                                                :
                                                                                <>
